...
class ThundrBot:
    ...
    async def enhanced_form_filling(self):
        ...
        try:
            ...
            # 1. Gender selection with improved selectors
            ...
            for selector in looking_selectors:
                try:
                    element = await self.page.wait_for_selector(selector, timeout=3000)
                    if element:
                        await element.click()
            ...
            # 5. Start button with enhanced detection
...
async def main():
    print('[ROCKET] Starte Enhanced Thundr Bot - Optimized Version...')
